...
const ONKASA_ROLLOUT: RolloutCase[] = [
  ...
  { label: 'Döviz bozdurma', path: '/reception/departures?tab=fx', heading: /Döviz Bozdurma Listesi/i, tableAssert: true },
  { label: 'Günlük kur girişi', path: '/reception/departures?tab=rates', heading: /Günlük Kur Girişi/i },
  { label: 'Depozit işlemleri', path: '/reception/vacant?tab=deposit', heading: /Depozit İşlemleri/i, tableAssert: true },
];
