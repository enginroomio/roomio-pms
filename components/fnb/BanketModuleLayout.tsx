...
import { banketModuleLayoutDefaults } from '@/lib/navigation/banket-layout';
...
export function BanketModuleLayout({
  title,
  description,
  menuSearch,
  segment,
  ...
  const layout = banketModuleLayoutDefaults(menuSearch, ...segments);
