...
import { gunsonuModuleLayoutDefaults } from '@/lib/navigation/gunsonu-layout';
...
export function GunSonuModuleLayout({
  title,
  description,
  menuSearch,
  segment,
  ...
  const layout = gunsonuModuleLayoutDefaults(menuSearch, ...segments);
