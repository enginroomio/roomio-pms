...
import { arkaburoModuleLayoutDefaults } from '@/lib/navigation/arkaburo-layout';
...
export function ArkaBuroModuleLayout({
  title,
  description,
  menuSearch,
  segment,
  ...
  const layout = arkaburoModuleLayoutDefaults(menuSearch, ...segments);
