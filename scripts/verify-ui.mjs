...
async function main() {
  ...
  const specs = [
    ...
    ['E2E — orijinal şablonlar', 'e2e/home-orijinal-template.spec.ts'],
    ['E2E — bulut yedek', 'e2e/cloud-backup.spec.ts'],
    ['E2E — gün sonu sihirbazı', 'e2e/eod-wizard.spec.ts'],
    ['E2E — gün sonu rollout', 'e2e/rollout-gunsonu.spec.ts'],
    ...
    ['E2E — kat rollout', 'e2e/rollout-kat.spec.ts'],
    ['E2E — misafir rollout', 'e2e/rollout-misafir.spec.ts'],
    ['E2E — raporlar rollout', 'e2e/rollout-raporlar.spec.ts'],
    ['E2E — arka büro rollout', 'e2e/rollout-arkaburo.spec.ts'],
    ['E2E — ayarlar rollout', 'e2e/rollout-ayarlar.spec.ts'],
    ['E2E — sistem rollout', 'e2e/rollout-sistem.spec.ts'],
