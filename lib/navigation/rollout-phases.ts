...
export const ROLLOUT_PHASES: RolloutPhase[] = [
  ...
  },
  {
    ...
    steps: [
      { id: 'rpt-hub', label: 'Raporlar Merkezi', href: '/reports?hub=raporlar' },
      { id: 'rpt-program', label: 'Raporlama programı', href: '/reports' },
      ...
      { id: 'rpt-user', label: 'Kullanıcı tanımlı raporlar', href: '/reports?tab=user' },
      { id: 'rpt-design', label: 'Rapor tasarım', href: '/reports?tab=design' },
      { id: 'rpt-special', label: 'Özel raporlar', href: '/reports?tab=special' },
    ],
  },
  {
    id: 'gunsonu',
    ...
    steps: [
      { id: 'eod-hub', label: 'Gün Sonu Merkezi', href: '/reports?hub=gunsonu' },
      ...
      { id: 'eod-backup', label: 'Yedek al', href: '/reports?tab=eod&action=backup' },
