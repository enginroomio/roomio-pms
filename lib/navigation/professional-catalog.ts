...
export const PROFESSIONAL_MODULES: ProModule[] = [
  ...
  { id: 'rez-group', group: 'Rezervasyon', label: 'Grup Rezervasyon', href: '/reservations?tab=group', status: 'live' },
  { id: 'rate-calendar', group: 'Rezervasyon', label: 'Rate Takvim', href: '/settings?section=rate-plans', status: 'live' },
  ...
  { id: 'group-pickup', group: 'Rezervasyon', label: 'Grup Pickup Raporu', href: '/reservations?tab=group', status: 'live' },
